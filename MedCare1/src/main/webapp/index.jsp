...
<div class="container p-3">
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="height: 350px;">
            <img class="w-100 h-100" alt="" src="img/Dr2r.png">
        </div>
	...
	<div class="container p-2">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/Dr2.png" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/Dr4.png" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/Dr3.png" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/Dr5.png" width="250px" height="300px">
