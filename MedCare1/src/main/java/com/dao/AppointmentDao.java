...
public class AppointmentDao {
	...
	public boolean addAppointment(Appointment ap) 
	{
		...
		try 
		{
			...
			String sql = "insert into appointment(user_id,fulname,gender,age,appoin_date,email,phNo,diseases,doctor_id,address,status) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public List<Appointment> getAllAppointmentByLogin(int doctorId)
	{
